...
router.put("/books/:bookId",  Middleware.authorization, bookController.updateBook)  //authorisation


// ====================== Delete Book by book id API ====================
router.delete ("/books/:bookId",  Middleware.authorization, bookController.deleteBookById) //authorisation
...
router.delete("/books/:bookId/review/:reviewId", reviewController.deletedReview) //authorisation
